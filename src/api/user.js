...
export const userCaptchaService = (randKey) => {
    return request.get('user/captcha?randKey='+randKey)
}

export const userPublicKeyService = (randKey) => {
    return request.get('user/rsa?randKey='+randKey)
}